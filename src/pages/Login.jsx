    ...
    <div className="login-page">
      <div className="login-card">
        <div className="login-header">
          <img src="/proactLogo.png" alt="PROACT LOGO" className="login-logo-img" />
      ...
      <div className="login-footer">
        ...
        Improved by DOST ITSM Unit OJT from <span className="highlight-name"><a href="https://www.mmsu.edu.ph" target="_blank" rel="noopener noreferrer" className="footer-link">Mariano Marcos State University</a> <a href="change :>" target="_blank" rel="noopener noreferrer" className="footer-link">CCIS</a></span>
      </div>
    </div>
  )
}